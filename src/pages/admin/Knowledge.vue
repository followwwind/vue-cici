<template>
	<section>
		...
		<el-table :data="tableList" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;">
			...
			<el-table-column prop="categoryId" label="知识点类别" width="120" sortable>
			</el-table-column>
			<el-table-column prop="content" label="知识点内容" width="120" sortable>
			</el-table-column>
			<el-table-column prop="isShare" label="是否分享，0：否，1：是" width="120" sortable>
			</el-table-column>
		...
		<el-dialog :title = "isAdd?'新增':'修改'" :visible.sync = "formVisible" :close-on-click-modal = "false">
			<el-form :model="form" label-width="80px" :rules="formRules" ref="form">
				...
				<el-form-item label="知识点类别" prop="categoryId">
					<el-input v-model="form.categoryId" auto-complete="off"></el-input>
				</el-form-item>
				<el-form-item label="知识点内容" prop="content">
					<el-input v-model="form.content" auto-complete="off"></el-input>
				</el-form-item>
				<el-form-item label="是否分享，0：否，1：是" prop="isShare">
					<el-input v-model="form.isShare" auto-complete="off"></el-input>
				</el-form-item>
			</el-form>
