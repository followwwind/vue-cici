<template>
	<section>
		...
		<el-table :data="tableList" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;">
			...
			<el-table-column prop="paperId" label="试卷id" width="120" sortable>
			</el-table-column>
			<el-table-column prop="issueId" label="题目id" width="120" sortable>
			</el-table-column>
			<el-table-column prop="answer" label="答案，A,B,C,D" width="120" sortable>
			</el-table-column>
		...
		<el-dialog :title = "isAdd?'新增':'修改'" :visible.sync = "formVisible" :close-on-click-modal = "false">
			<el-form :model="form" label-width="80px" :rules="formRules" ref="form">
				...
				<el-form-item label="试卷id" prop="paperId">
					<el-input v-model="form.paperId" auto-complete="off"></el-input>
				</el-form-item>
				<el-form-item label="题目id" prop="issueId">
					<el-input v-model="form.issueId" auto-complete="off"></el-input>
				</el-form-item>
				<el-form-item label="答案，A,B,C,D" prop="answer">
...
<script>
	import {save,update,del,pageList} from '@/api/paperRecord';
	export default {
		data() {
			return {
				filters: {
