<template>
	<section>
		...
		<el-table :data="tableList" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;">
			...
			<el-table-column prop="name" label="试卷名称" width="120" sortable>
			</el-table-column>
			<el-table-column prop="keyword" label="关键词搜索" width="120" sortable>
			</el-table-column>
			<el-table-column prop="count" label="题目数量" width="120" sortable>
			</el-table-column>
			<el-table-column prop="createTime" label="时间" width="120" sortable>
			</el-table-column>
...
<script>
	import {save,update,del,pageList} from '@/api/paper';
	export default {
		data() {
			return {
				filters: {
