<template>
	<section>
		...
		<el-table :data="tableList" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;">
			...
			<el-table-column prop="info" label="简介" width="120" sortable>
			</el-table-column>
			<el-table-column prop="url" label="超链接" width="120" sortable>
			</el-table-column>
...
<script>
	import {save,update,del,pageList} from '@/api/learn';
	export default {
		data() {
			return {
				filters: {
