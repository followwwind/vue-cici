<template>
	<section>
		...
		<el-table :data="tableList" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;">
			...
			<el-table-column prop="content" label="题目内容" width="120" sortable>
			</el-table-column>
			<el-table-column prop="answer" label="题目选项答案" width="120" sortable>
			</el-table-column>
		...
		<el-dialog :title = "isAdd?'新增':'修改'" :visible.sync = "formVisible" :close-on-click-modal = "false">
			<el-form :model="form" label-width="80px" :rules="formRules" ref="form">
				...
				<el-form-item label="题目选项答案" prop="answer">
...
<script>
	import {save,update,del,pageList} from '@/api/issue';
	export default {
		data() {
			return {
				filters: {
