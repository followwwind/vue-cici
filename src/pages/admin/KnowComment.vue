<template>
	<section>
		...
		<el-table :data="tableList" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;">
			...
			<el-table-column prop="knowId" label="知识点id" width="120" sortable>
			</el-table-column>
		...
		<el-dialog :title = "isAdd?'新增':'修改'" :visible.sync = "formVisible" :close-on-click-modal = "false">
			<el-form :model="form" label-width="80px" :rules="formRules" ref="form">
				...
				<el-form-item label="知识点id" prop="knowId">
					<el-input v-model="form.knowId" auto-complete="off"></el-input>
				</el-form-item>
...
<script>
	import {save,update,del,pageList} from '@/api/knowComment';
	export default {
		data() {
			return {
				filters: {
